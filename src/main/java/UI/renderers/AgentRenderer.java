    ...
    public void drawAgent(GraphicsContext gc, Agent agent) {
        ...
        if (agent.isSelected()) {
            ...
            if (auxNode != null) {
                ...
                gc.fillOval(auxNode.getX() - (AGENT_RADIUS / 3.0), auxNode.getY() - (AGENT_RADIUS / 3.0),
                        AGENT_RADIUS / 1.5, AGENT_RADIUS / 1.5);
        ...
        switch (agent.getState()) {
            case AVAILABLE:
                agentColor = Color.web("#69F0AE");
                break;
            case CALCULATING:
                agentColor = Color.web("#FF9800");
                break;
            case WAITING:
                agentColor = Color.web("#FFEB3B");
                break;
            case RUNNING:
                agentColor = Color.web("#29B6F6");
                break;
            case OUT:
                agentColor = Color.web("#9E9E9E");
                break;
        }
